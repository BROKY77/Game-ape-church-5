...
const MyGame: React.FC<MyGameProps> = ({ game }) => {
    ...
    useEffect(() => {
        ...
        const nextPick = autoSelectedTiles.find((i) =>
            i >= 0 && i < BOARD_TILE_COUNT && !roundState.revealedTiles.includes(i)
        );
    ...
    }, [isAutoBetting, currentView, roundState.isLoading, roundState.revealedTiles.length, canReveal, autoSelectedTiles, canCashOut]);
    ...
    return (
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-8 lg:gap-10">
            ...
            <MyGameSetupCard
                ...
                setAutoSelectedTiles={setAutoSelectedTiles}
