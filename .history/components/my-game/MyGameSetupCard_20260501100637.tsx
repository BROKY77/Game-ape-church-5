                    ...
                    <div className="relative" ref={mineListRef}>
                        ...
                        >
                            <div className="flex items-center justify-between">
                                <span>{mineCount}</span>
                                <span className="text-[#9FB2C0] flex items-center gap-2"><span className="text-[#6b8394]">/25</span><span style={{ display: "inline-block", transform: isMineListOpen ? "rotate(0deg)" : "rotate(-90deg)" }}>▼</span></span>
                            </div>
                        </button>
