        ...
        <div className="mines-grid-root">
            ...
            >
                {Array.from({ length: BOARD_TILE_COUNT }, (_, i) => {
                    ...
                    const isManualChosen = !isAutoBetting && !showAutoSelectedTiles && revealedTiles.includes(i);
                    return (
                        <button
                            key={i}
                            onPointerDown={(event) => {
                        ...
                        >
                            ...
                            {(state === "exploded" || state === "mine-revealed") && (
                                <img
                                    ...
                                    alt="Bomb"
                                    className={`mines-tile-icon ${state === "exploded" ? "mines-tile-exploded-icon" : "mines-tile-mine-icon"}`}
                                    draggable={false}
                                />
                            )}
                        </button>
