...
const MyGameSetupCard: React.FC<MyGameSetupCardProps> = ({
    ...
    }, [packageLocked, isAutoBetting, manualRoundsDraft, numberOfSpins, hasActivePackage, betMode]);
    ...
    }, [isAutoBetting, showStoppedAutoSummary, autoBetsDraft, autoBetCount, betMode]);
