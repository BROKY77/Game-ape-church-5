        ...
        <Card className="lg:basis-1/3 p-5 flex flex-col border-[#2A3640] bg-[#1A2328] rounded-xl">
            <CardContent className="p-0">
                ...
                <div className="mt-1 mb-3" style={{ opacity: minesControlDisabled ? 0.5 : 1 }}>
                    ...
                    <div className="relative" ref={mineListRef}>
                        <button
                            type="button"
                        ...
                        >
                            <div className="flex items-center justify-between">
                                <span>{mineCount}</span>
                                <span className="text-[#9FB2C0] flex items-center gap-2"><span className="text-[#6b8394]">/25</span><span style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: "1em", height: "1em", transform: isMineListOpen ? "rotate(0deg)" : "rotate(90deg)" }}>▼</span></span>
                            </div>
                        </button>
