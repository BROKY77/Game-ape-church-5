...
const Mines: React.FC<MinesProps> = ({ game }) => {
    ...
    useEffect(() => {
        ...
        void fetch("/mines/audio/song.mp3")
    ...
    return (
        <div className="mines-root flex w-full flex-col gap-4 sm:gap-8 lg:flex-row lg:flex-nowrap lg:items-stretch lg:gap-10 lg:overflow-x-auto">
            <GameWindow
                game={game}
