...
const GameWindow: React.FC<GameWindowProps> = ({
    ...
    return (
        <div
            className={cn(
                "w-full rounded-[12px] border-[2.25px] border-[#2A3640] sm:border-[3.75px] lg:relative lg:w-[760px] lg:min-w-[760px] lg:flex-none lg:border-[4.68px] relative overflow-hidden",
            )}
        >
